...
ll computeXOR(ll n)
{
  ...
  */
  int printNcR(double n, double r){
    long long p = 1.00, k = 1.00;
    if (n - r < r)
        r = n - r;
    if (r != 0) {
        while (r) {
  ...
  int main(){
      ...
      for(ll i=0; i<s2.length(); i++){
       ...
       if(sum1==sum2 && count==0)cout <<"1.000000000000"<< endl;
       else
       {
         double t=pow(2,count);
         if(sum1==sum2 && count!=0){
           if(count%2!=0)cout << "0.000000000000" << endl;
           else
           {
             double z=(printNcR(count,count/2))/t;
            cout << setprecision(12) << fixed << z << endl;
           }
         }
         else
         {
           ll temp=abs(sum1-sum2);
           if(temp>count)cout << "0.000000000000" << endl;
           else if(temp==count) {double z=(1.000000000000)/t;cout << setprecision(12) << fixed << z << endl;}
           else {
             if((count-temp)%2==0){
                ll me=(count-temp)/2;
                double z=(printNcR(count,temp+me))/t;
            cout << setprecision(12) << fixed << z << endl;
             }
             else{
